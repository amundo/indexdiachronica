...
\subsection{Proto-Algonquian to Mi'kmaq}{\it Pogostick Man with acknowledgment to dhok}, from Audrey Marie (1986), {\it The Fundamentals of Micmac Historical Morphology}, citing Hewson, John (1973), ``Proto-Algonkian Reflexes in Micmac'', and Hewson, John (1983), ``Some Micmac Etymologies''
...
*D \change\ \ipa{r}\\
*j \change\ \ipa{g} / possible exception in word-initial position?\\
*Z \change\ \ipa{r}\\
...
*R seems to have had a few different reflexes, mainly one of /\ipa{l g j}/; if /\ipa{g j}/ occurred, /\ipa{g}/ was more probable at word boundaries and /\ipa{j}/ was more probable medially\\
\{\ipa{q,h}\} \change\ \O\\
...
C \change\ \O\ / _\#\\
\ipa{q} \change\ \O\\
*R \change\ \{\O,\ipa{r}\} (the former seems more common)\\
\ipa{\textltailn\ c} *j \change\ \ipa{n s z}\\
...
({\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf})

\subsection{Proto-Chumash to Barbare\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}

R[- glottalized]V\ipa{\super P}R \change\ \ipa{\super P}RVR[- glottalized] / _\$\\
R[- glottalized]VO\ipa{'} \change\ \ipa{\super P}RVO[- ejective] / _\$

\subsection{Proto-Chumash to Cruze\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}

\ipa{k} \change\ \ipa{tS} ``(`in certain cases')''

\subsection{Proto-Chumash to Inse\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}

\ipa{t' q'} \change\ \ipa{t q}\\
\ipa{\super P}N \ipa{\super Pw} \change\ N \ipa{w}\\

\subsection{Proto-Chumash to Obispe\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}
...
\subsection{Proto-Chumash to Purisime\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}

\ipa{\super Pj} \change\ \O\\
\ipa{q'} \change\ \ipa{q}

\subsection{Proto-Chumash to Venture\~{n}o}{\it CatDoom}, from Klar, Kathryn (1977), {\it Topics in Historical Chumash Grammar}. \url{http://linguistics.berkeley.edu/~survey/documents/dissertations/klar-1977.pdf}
...
\subsubsection{Proto-Ofai\'{e}-J\^{e} to Proto-J\^{e}}{\it Pogostick Man}, from Gudschinsky, Sarah C. (1971), ``Ofaié-Xavante, a Jê Language''
...
\section{Lenmichian}The following inventory for Proto-Lenmichian is posited by Constenla (2005).
...
\subsection{Proto-Lenmichian to Proto-Chibchan}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Macro-Chibchan languages''. {\it Wikipedia, the Free Encyclopedia}. \textless\url{https://en.wikipedia.org/w/index.php?title=Macro-Chibchan_languages&oldid=672637970}\textgreater, presumably citing Constenla Umaña, Adolfo (2005), ``?`Existe relaci\'{o}n geneal\'{o}gica entre las lenguas misumalpas y las chibchenses?''. {\it Estudios de Lingüística Chibcha} 24:7 -- 85

\ipa{l} \change\ \ipa{R}\\
\ipa{w} \change\ \O

\subsection{Proto-Lenmichian to Proto-Lencan}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Macro-Chibchan languages''. {\it Wikipedia, the Free Encyclopedia}. \textless\url{https://en.wikipedia.org/w/index.php?title=Macro-Chibchan_languages&oldid=672637970}\textgreater, presumably citing Constenla Umaña, Adolfo (2005), ``?`Existe relaci\'{o}n geneal\'{o}gica entre las lenguas misumalpas y las chibchenses?''. {\it Estudios de Lingüística Chibcha} 24:7 -- 85
...
\subsection{Proto-Lenmichian to Proto-Misumalpan}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Macro-Chibchan languages''. {\it Wikipedia, the Free Encyclopedia}. \textless\url{https://en.wikipedia.org/w/index.php?title=Macro-Chibchan_languages&oldid=672637970}\textgreater, presumably citing Constenla Umaña, Adolfo (2005), ``?`Existe relaci\'{o}n geneal\'{o}gica entre las lenguas misumalpas y las chibchenses?''. {\it Estudios de Lingüística Chibcha} 24:7 -- 85
...
\subsection{Proto-Nyulnyulan to Bardi}
...
\paragraph{Old Tibetan to Amdo dialects}{\it Pogostick Man}, from Jacques, Guillaume (2004), ``Phonologie et Morphologie du Japhug (rGyalrong)''. Université Paris-Diderot - Paris VII \textless tel-00138568\textgreater. \textless\url{https://tel.archives-ouvertes.fr/file/index/docid/138568/filename/these-japhug.pdf}\textgreater
