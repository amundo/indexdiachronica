...
\section{Afro-Asiatic}\tab For these Afro-Asiatic changes, s$_1$, s$_2$, s$_3$, h$_1$, and h$_2$ are consonants, believed to have most likely been fricatives, of indeterminate reconstruction. Dashes denote stem boundaries. What is given here as *\ipa{q} is described by Ehret as a ``voiceless pharyngeal plosive''.

\tab The phonemic inventory of Proto-Afro-Asiatic has been reconstructed as follows:
%%%%% Possibly incorrect hereÉcorroborate with somebody else?
...
\subparagraph{Proto-Agaw to Awngi}{\it Pogostick Man}, from Fallon, Paul D. (2009), ``The Velar Ejective in Proto-Agaw". In {\it Selected Proceedings of the 39th Annual Conference on African Linguistics}, Ojo, Akinloye and Lioba Moshi (Eds.), 10 -- 22. Sommerville, MA: Cascadilla Proceedings Project. \url{http://www.lingref.com}, document \#2182, citing Appleyard, David L. (2006), {\it A comparative dictionary of the Agaw languages}. (Cushitic Language studies, 24.) Cologne: R\"{u}diger K\"{o}ppe Verlag.
...
{\it NB: Words borrowed directly from CA/MSA seem to be immune to these changes. Also, unless otherwise noted, changes also apply to geminate consonants.}
...
{\it NB: This is probably highly incomplete}
...
{\it NB: \ipa{@} could be realized as an ultrashort [\ipa{a}], [\ipa{e}], or [\ipa{o}] depending on its surroundings}
...
{\it NB: These aren't all true sound changes per se, since Modern Israeli Hebrew was artificially revived and is an amalgamation of dialects}
...
\tab (From Wikipedia contributors (2011), \textquotedblleft Proto-Algonquian language". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Algonquian_language&oldid=440788532})
...
\ipa{tem} \{\ipa{ken,pen}\} \change\ \ipa{m: n:}\\
...
\ipa{a} \change\ \ipa{o} / \ipa{m}_\ipa{w} ``[in the suffix \textbf{*-amaw}]"\\
...
\tab NB: The Altaic grouping is highly controversial and is not accepted by many mainstream linguists.

\tab (From Wikipedia contributors (2011), \textquotedblleft Altaic languages". \textit{Wikipedia, the Free Encyclopedia.} \url{http://en.wikipedia.org/w/index.php?title=Altaic_languages&oldid=453651228})

\subsection{Proto-Altaic to Proto-Japonic}{\it Pogostick Man}, from Wikipedia contributors (2011), ``Altaic languages''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Altaic_languages&oldid=453651228}, citing Sarostin, Sergei A., Anna V. Dybo, and Oleg A. Mudrak (2003), {\it Etymological Dictionary of the Altaic Languages}. Leiden: Brill Academic Publishers
...
{\it Pogostick Man}, from Firespeaker.org wiki contributors (2014), ``Turkic sound changes". \url{http://wiki.firespeaker.org/Turkic_sound_changes}
...
\subsubsection{Proto-Turkic to Proto-Kypchak}{\it Pogostick Man}, from Firespeaker.org wiki contributors (2014), ``Turkic sound changes". \url{http://wiki.firespeaker.org/Turkic_sound_changes}
...
\paragraph{Proto-Kypchak to Kazakh}{\it Pogostick Man}, from Firespeaker.org wiki contributors (2014), ``Turkic sound changes". \url{http://wiki.firespeaker.org/Turkic_sound_changes}
...
\paragraph{Proto-Kypchak to Kyrgyz}{\it Pogostick Man}, from Firespeaker.org wiki contributors (2014), ``Turkic sound changes". \url{http://wiki.firespeaker.org/Turkic_sound_changes}
...
\subsubsection{Proto-Turkic to Sakha}{\it Pogostick Man}, from Firespeaker.org wiki contributors (2014), ``Turkic sound changes". \url{http://wiki.firespeaker.org/Turkic_sound_changes}
...
\section{Athabaskan}\tab Wikipedia gives the following reconstructions, adapted from Cook (1981), Krauss \&\hspace{0pt} Golla (1981), Krauss \&\hspace{0pt} Leer (1981), and Cook \&\hspace{0pt} Rice (1981) for the consonants and from Leer (2005:284) for the vowels; the vowel phonemes in parentheses are reduced.
...
\tab NB: The great majority of changes in this section are for the respective \textit{series} of consonants, not for individual ones; therefore, changes specific to single consonants are marked so, and the reader should assume that unless explicitly stated, all of the following changes apply to the entire consonantal series. Whimemsz gives the following abbreviations, derived from the voiceless members of each series:
\begin{enumerate}
\item \ipa{t}, dental stops
\item \ipa{t\textbeltl}, laterals
\item \ipa{ts}, dental affricates and fricatives
\item \textipa{tS}, palatals
\item \textipa{tS\super w}, labialized palatals
\item \ipa{k}, front (palatalized) velars
\item \ipa{q}, uvulars
\item \ipa{q\super w}, labialized uvulars
\end{enumerate}
\tab Whimemsz was unsure of the abbreviation of the glottal series. In addition, there also exist a series of (inter-?)dentals, abbreviated \textipa{tT}, and one of retroflexes, abbreviated \textipa{t\:s}. Changes marked with an asterisk, *, apply to the individual phone(me)s. These series will be referred to in this document by their respective numbers as per the above; the (inter)dental series and the retroflex series will here be treated as (9) and (10), respectively.

\tab (From Whimemsz's statements from the TCL thread and Wiki, and from Wikipedia contributors (2011), \textquotedblleft Athabaskan languages". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Athabaskan_languages&oldid=454112398})

\subsection{Proto-Athabaskan to Ahtna}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{4,5\} \change\ 3\\
6 \change\ 4 / in Mentasta Ahtna\\
\{\ipa{S(\super w),x}\} \change\ \ipa{s}\\
\ipa{A @ U} \change\ \ipa{a e o}\\
V\ipa{\super P} \change\ V[-glottalized]

\subsection{Proto-Athabaskan to Babine}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{4,5\} \change\ 3\\
\ipa{u A U} \change\ \{\ipa{o,u}\} \ipa{@ u}\\
V\ipa{\super P} \change\ V[-glottalized]

\subsection{Proto-Athabaskan to Beaver}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 \change\ 9 (most often back to 3, however)\\
\{4,5\} \change\ 3\\
6 7 \change\ 4 6\\
1 \change\ 4 / _\{\ipa{i,e,u}\}, in the British Columbian dialect\\
\{\ipa{n,\textltailn}\} \change\ \ipa{d} / \$_V[-nas] (\change\ \ipa{dZ} in the British Columbian dialect)\\
\ipa{A} \change\ \ipa{@}\\
V\ipa{\super P} \change\ V[+high tone]

\subsection{Proto-Athabaskan to Chilcotin}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

Series 3 desibilantizes\\
V \change\ \{V\ipa{\super P},V[+RTR]\}\\
\{4,5\} 6 \change\ 3 4\\
Series 7 incompletely moves to series 6, the latter being more common\\
\ipa{e} \{\ipa{A,@}\} \change\ \ipa{i} \{\ipa{e,I}\}\\
V\ipa{\super P} \change\ V[+high tone]

\subsection{Proto-Athabaskan to Chipewyan}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 \{4,5\} 6 7 \change\ 9 3 4 6\\
\ipa{t} \change\ \ipa{k} (not for all speakers)\\
\{A,O'\} \change\ F / _\$\\
\ipa{A U} \change\ \ipa{a o}\\
V\ipa{\super P} \change\ V[+high tone]

\subsection{Proto-Athabaskan to Dakelh}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{4,5\} 6 7 \change\ 3 4 6\\
\ipa{u} \{\ipa{A,U}\} \change\ \{\ipa{o,u}\} \ipa{@}\\
V\ipa{\super P} \change\ V[-glottalized]

\subsection{Proto-Athabaskan to Deg Hit'an}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 4 \change\ 9 3\\
5 \change\ 10 (\change\ 3 in Kuskokwim dialect)\\
6 \change\ \{6,4\}\\
...
\subsection{Proto-Athabaskan to Dena'ina}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{4,5\} \change\ 4 (\change\ 3 in Upper Inlet dialect)\\
\ipa{e a u} \{\ipa{@,U}\} \change\ \ipa{a u i @}\\
\{\ipa{S(\super w),x} \{\ipa{z,Z(\super w),G}\} \change\ \ipa{s j}\\
V\ipa{\super P} \change\ V[-glottalized]

\subsection{Proto-Athabaskan to Dogrib}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Easter Gwich'in}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\tab {\it NB: Here, $\langle${\bf 3}$\rangle$ represents a sound that Whimemsz says ``is between'' series 3 and 4 POA-wise.}

3 6 \change\ 4 {\bf 3} / _E\\
3 6 \change\ 9 4 / else\\
4 5 7 \change\ 3 10 6\\
...
\subsection{Proto-Athabaskan to Han}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 4 5 6 7 \change\ 9 3 10 4 6\\
...
\subsection{Proto-Athabaskan to Holikachuk}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Lower Koyukon}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Upper Koyukon}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Upper Kuskokwim Kolchan}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

4 5 6 7 \change\ 3 10 4 6\\
\ipa{e a} \{\ipa{A,U}\} \change\ \ipa{a o \u{u}}\\
V\ipa{\super P} \change\ V[-glottalized]\\

\subsection{Proto-Athabaskan to Sarcee}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Sekani}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 \change\ 9 (\change\ 3 again in some areas)\\
\{4,5\} 6 7 \change\ 3 4 6\\
1 \change\ 4 / _\{\ipa{i,e,u}\} ! in Ware Sekani\\
\ipa{U} \change\ \ipa{o}\\
V\ipa{\super P} \change\ V[+high tone]

\subsection{Proto-Athabaskan to Bearlake Slavey-Hare}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Hare Slavey-Hare}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\ipa{t\textbeltl\super h tS(\super w)\super h k\super h} \change\ \ipa{\textbeltl\ s S}\\
\{4,5\} 6 \change\ 3 4 (with exceptions)\\
7 \change\ 6 \\
\O\ \change\ \ipa{j} / _\ipa{e}\\
\ipa{\textbeltl} \change\ \ipa{l}\\
\ipa{ts ts\super h ts'} \{\ipa{s,z}\} \change\ \{\ipa{k\super w,p}\} \ipa{f w\super P w}

\subsection{Proto-Athabaskan to Mountain Slavey-Hare}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Slavey Slavey-Hare}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

C \change\ \{\ipa{h,P}\} / _\#\\
\ipa{A @ U} \change\ \ipa{a e o}\\
\{4,5\} 6 7 \change\ 3 4 6

\subsection{Proto-Athabaskan to Tahltan-Kaska-Tagish}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\ipa{A @ U} \change\ \ipa{a} \{\ipa{i,e}\} \ipa{u}\\
C' \change\ C / _\$\\
7 \change\ 6

\subsubsection{Tahltan-Kaska-Tagish to Kaska}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

V\ipa{\super P} \change\ V[+high tone]\\
3 \{4,5\} \change\ 9 3\\
6 \change\ 4 (although /\ipa{x\super j}/ stays as such in a few dialects)

\subsubsection{Tahltan-Kaska-Tagish to Tagish}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{4,5\} 3 \change\ 3 3\ipa{\super j}

\subsubsection{Tahltan-Kaska-Tagish to Tahltan}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

\{5,6\} \change\ 4 (although /\ipa{x\super j}/ stays as such in a few dialects)

\subsection{Proto-Athabaskan to Tanacross}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

6 \change\ 4 / ! _\$\\
3 4 5 7 \change\ 9 3 10 6\\
S' \change\ S / _\$\\
V\ipa{\super P} \change\ V[+high tone]\\
...
\subsection{Proto-Athabaskan to Lower Tanana}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Upper Tanana}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
\subsection{Proto-Athabaskan to Tsetsaut}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
4 \change\ 3\\
Series 5 apparently moved its POA to the labiodental or bilabial position\\
6 7 \change\ 4 6\\
C \change\ \O\ / _\$ in many cases\\
\ipa{U} \change\ \ipa{o}

\subsection{Proto-Athabaskan to Northern Tutchone}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85

3 \{4,5\} \change\ 9 3\\
6 \change\ 4 (although /\ipa{x\super j}/ remained as such in a few dialects)\\
7 \change\ 6\\
\{\ipa{A,@,U}\} \change\ \{\ipa{a,o}\}\\
...
\subsection{Proto-Athabaskan to Southern Tutchone}{\it Whimemsz}, from Krauss, Michael and Victor Golla (1981), ``Northern Athapaskan Languages". {\it Handbook of North American Indians}, Vol. 6 (Subarctic), 67 -- 85
...
1. Tense before _S\#; laryngealized elsewhere\\
2. Laryngealized
...
1. Level before _S\#; dipping otherwise\\
2. Laryngealized
...
Nasal & \ipa{m} & \ipa{n} & \ipa{\textltailn} & & \textipa{N} & (\textipa{q,P}) \\
Plosive & \ipa{p b} & \ipa{t d} & & \textipa{\:n} & \ipa{k g g\super j} & \\
...
\tab (From Wikipedia contributors (2011), \textquotedblleft Proto-Austronesian language". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Austronesian_language&oldid=453318098})

\subsection{Proto-Austronesian to Proto-Malayo-Polynesian}{\it Pogostick Man}, from Wikipedia contributors (2011), ``Proto-Austronesian lanuage". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Austronesian_language&oldid=453318098}
...
``*\ipa{i} and *\ipa{u} often became mid-vowels (but not necessarily in the same cases as Sasak)\\
V(\ipa{h}) \change\ V(\ipa{q}) / _\# (again, might've been a retention?)\\
S[+ voice] \change\ \O\ / _N\\
S[+ voice] \change\ \O\ / N_\\
...
\ipa{f} \change\ \ipa{s}\\
\ipa{v \textbardotlessj\ g} \change\ \ipa{f c k} / V_V\\
...
\subsection{Proto-Austronesian to Proto-Oceanic}{\it Pogostick Man}, from Wikipedia contributors (2011), ``Proto-Austronesian language". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Austronesian_language&oldid=453318098}
...
\subsubsection{Proto-Oceanic to Hiw}{\it Theta}, from Fran\c{c}ois, Alexander, ``Unraveling the history of the vowels of seventeen north Vanuatu languages"; and Fran\c{c}ois, Alexander, ``Phonotactics and the prestopped velar lateral of Hiw"

\ipa{p(\super w)} \{\ipa{c,\textbardotlessj}\} \ipa{k q} \change\ \ipa{B(\super w) s G} \O\\
\ipa{B b m} \change\ \ipa{B\super w b\super w m\super w} / sporadic, typically near *\ipa{u}\\
...
\ipa{G g\;L} do a lot of changing with and into each other\\
``[O]ccasional metathesis"
V \change\ \O\ / _(C)"V if the second vowel is lower or if both are high\\
V \change\ \ipa{@} / _(C)"V if the first vowel is of equal or lesser height\\
\ipa{a} \change\ \ipa{e} / _(C)\{\ipa{o,e,i}\} (occasionally)
\ipa{@} \change\ V / _(C)V (sporadic)\\
\ipa{u}(C)V[+ high] \ipa{u}(C)\ipa{o} \ipa{u}(C)\ipa{e} \ipa{u}(C)\ipa{a} \change\ \{\ipa{u,i}\}(C) \ipa{e}(C)\ipa{@} \ipa{u}(C)\ipa{@} \{\ipa{u,8}\}(C)\ipa{@}\\
\ipa{o}(C)V[+ high] \ipa{o}(C)V[+ mid] \ipa{o}(C)\ipa{a} \change\ \ipa{8}(C) \ipa{o}(C) \ipa{O}(C)\ipa{@}\\
\ipa{a}(C)V[+ high] \ipa{a}(C)V[+ mid] \ipa{a}(C)\ipa{a} \change\ \ipa{O}(C) \ipa{a}(C) \{\ipa{a,O}\}(C)\ipa{@}\\
...
E \change\ \ipa{I} (sporadic)\\
V$_0$V$_0$ \change\ V$_0$\\
*\ipa{u} before the accent tended to transfer its labialness to the preceding consonant when it dropped
...
\ipa{w} \change\ \O\ (? Tnb [\ipa{w}] may just be phonetically determined)\\
...
\subsection{Proto-Austronesian to Proto-Paiwan}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320
...
\subsubsection{Proto-Paiwan to Northern Paiwan}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320

\ipa{c \textbardotlessj\ q \:l} \change\ \ipa{t d P l}\\
Something about final stress and preceding /\ipa{@}/

\subsubsection{Proto-Paiwan to Central Paiwan}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320

\ipa{w} \change\ \ipa{v} / _\#\\
Something about final stress and preceding /\ipa{@}/

\subsubsection{Proto-Paiwan to Southern Paiwan}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320
...
\{\ipa{t,k}\} \ipa{q} \change\ \ipa{P k} / _C\\
...
\ipa{s} \change\ \ipa{t} / _V ! _E\\
\ipa{s} \change\ \ipa{t} / _\#\\
\ipa{s} \change\ \ipa{c}\&\ (I'm not sure what that represents; the paper doesn't explain what it is)\\
...
\subsection{Proto-Austronesian to Proto-Rukai}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320
...
\subsubsection{Proto-Rukai to Budai Rukai}{\it Pogostick Man}, from Chen, Chun-Mei (2006), {\it A Comparative Study on Formosan Phonology: Paiwan and Budai Rukai} 313 Ð 320
...
\tab The citation format for Nichols (2003) is modified from that found in Wikipedia contributors (2014), ``Northeast Caucasian languages". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Northeast_Caucasian_languages&oldid=610673712}, and is assumed to be the same article. The publication date for User:Petusek's page is taken from the revision history at \url{https://en.wikipedia.org/w/index.php?title=User:Petusek/Drafts/Northeast_Caucasian&oldid=351133322}.

\tab (From User:Petusek (2010), ``User:Petusek/Drafts/Northeast Caucasian". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=User:Petusek/Drafts/Northeast_Caucasian&oldid=351133322}, apparently citing Nichols, Johanna (2003), ``The Nakh-Daghestanian Consonant Correspondences", in Tuite, Kevin, and Dee Ann Holisky, {\it Current Trends in Caucasian, East European, and Inner Asian Linguistics: Papers in Honor of Howard I. Aronson} 207 -- 251)
...
\ipa{q q:' \;G} \change\ \ipa{x} \{\ipa{q(:)',gh}\} (not sure if that last $\langle$gh$\rangle$ should be \ipa{G})\\
...
{\it NB: These changes here probably aren't ``proper'' sound changes, whatever that's supposed to mean, but there doesn't seem to be any particular sound change or set of sound changes that defines this family, so I've elected to go with something that seems to nearly work and note the exceptions.}
...
\ipa{t}\ipa{\textbeltl} \ipa{t}\ipa{\textbeltl:} \ipa{t}\ipa{\textbeltl'} \ipa{d}\ipa{\textlyoghlig} \change\ \ipa{x ts x}/\ipa{ts' l}\\
...
\ipa{q\super w q\super w:} G\ipa{\super w} \change\ \ipa{\textcrh\super w q\super w G\super w}\\
...
\subsubsection{Proto-Circassian to Adyghe}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Proto-Circassian language". {\it Wikipedia, the Free Encyclopedia}, \url{http://en.wikipedia.org/w/index.php?title=Proto-Circassian_language&oldid=591849172}; and Wikipedia contributors (2014), ``Adyghe language". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Adyghe_language&oldid=593857358}
...
\subsubsection{Proto-Circassian to Kabardian}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Proto-Circassian language". {\it Wikipedia, the Free Encyclopedia}, \url{http://en.wikipedia.org/w/index.php?title=Proto-Circassian_language&oldid=591849172}
...
\ipa{k\super j} \change\ \ipa{tS}\\
\ipa{P}\raisebox{-0.6ex}{\textasciitilde}\ipa{q' P\super w}\raisebox{-0.6ex}{\textasciitilde}\ipa{P\super w}\\
...
\tab (From Wikipedia contributors (2013), ``Proto-Eskimo--Aleut language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Eskimo%E2%80%93Aleut_language&oldid=573345407})
...
F[+voice] \textrightarrow\hspace{0pt} F[-voice] / adjacent to \{S,ts\} \\
F[+voice] \textrightarrow\hspace{0pt} S / \textipa{\r*l}_ \\
\O \textrightarrow\hspace{0pt} n / \#_iN \textit{(NB: This one is sort of a guess, given a singular example in the text that isn't really commented upon)} \\
t \textrightarrow\hspace{0pt} s / _\{k,q\} \\
...
\tab (From Wikipedia contributors (2011), \textquotedblleft Pitch accent". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Pitch_accent&oldid=451210103}; and Wikipedia contributors (2011), \textquotedblleft Proto-Indo-European language". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Indo-European_language&oldid=455124616})

\subsection{Albanian}

\subsubsection{Proto-Indo-European to Gheg Albanian}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Albanian language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Albanian_language&oldid=582390175}
...
\subsubsection{Proto-Indo-European to Tosk Albanian}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Albanian language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Albanian_language&oldid=582390175}
...
\subsubsection{Proto-Indo-European to Artsakh Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Erevan Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Istanbul Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Kharpert Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Sebastia Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Southeast Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Southwest Armenian}{\it Mecislau \& Pogostick Man}, the latter citing Wikipedia contributors (2013), ``Armenian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Armenian_language&oldid=582063933}
...
\subsubsection{Proto-Indo-European to Avestan}{\it Pogostick Man, Alex Fink, and Tropylium}, the former two citing Wikipedia contributors (2013), ``Proto-Indo-Iranian language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Indo-Iranian_language&oldid=543625693}; and Alex Fink citing \url{https://en.wikipedia.org/wiki/Avestan_phonology}
...
\ipa{e:} \change\ \ipa{ia} / _\{\#,C\ipa{\super j}\} when stressed; ``ai and oi remain, but are written as \textless\ae ai oi oi\textgreater\, seemingly randomly"\\
\ipa{j} \change\ \O\\
...
\subsection{Proto-Indo-European to Dacian}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Dacian language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dacian_language&oldid=582406161}
...
\subsubsection{Common Germanic to Gothic}{\it Pogostick Man}, from Wright, Joseph (1910). {\it Grammar of the Gothic Language}, 2nd Ed.; and Wikipedia contributors (2014). ``Gothic language". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Gothic_language&oldid=635946920}
...
\paragraph{West Germanic to Anglo-Frisian}{\it Siride? \& Pogostick Man}, the latter citing Wikipedia contributors (2014), ``Anglo-Frisian languages". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Anglo-Frisian_languages&oldid=602286013}; Wikipedia contributors (2014), ``Old Frisian". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Old_Frisian&oldid=559739599}; and Wikipedia contributors (2014), ``Old English phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Old_English_phonology&oldid=602537992}
...
\subparagraph{Anglo-Frisian to Old English}{\it Pogostick Man}, from Wikipedia contributors (2011), ``Phonological history of English". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Phonological_history_of_English&oldid=453796112}
...
\subparagraph{Midlands Middle English to Early Modern English}{\it Pogostick Man}, from FireSpeakerWiki contributors (2013), ``English sound changes". {\it FireSpeakerWiki}. \url{http://wiki.firespeaker.org/English_sound_changes}
...
\subparagraph{Early Modern English to American English}{\it Pogostick Man}, from FireSpeakerWiki contributors (2013), ``English sound changes". {\it FireSpeakerWiki}. \url{http://wiki.firespeaker.org/English_sound_changes}; and my Phonetic Description class
...
\subparagraph{Early Modern English to Australian English}{\it Pogostick Man}, from FireSpeakerWiki contributors (2013), ``English sound changes". {\it FireSpeakerWiki}. \url{http://wiki.firespeaker.org/English_sound_changes}; and my Phonetic Description class
...
\subparagraph{Early Modern English to British English}{\it Pogostick Man}, from FireSpeakerWiki contributors (2013), ``English sound changes". {\it FireSpeakerWiki}. \url{http://wiki.firespeaker.org/English_sound_changes}
...
\subparagraph{Early Northern Middle English to Scots}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Phonological history of Scots". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Phonological_history_of_Scots&oldid=582962563}; and Wikipedia contributors (2014), ``Scottish Vowel Length Rule". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Scottish_vowel_length_rule&oldid=589349104}
...
\subparagraph{Anglo-Frisian to Old Frisian}{\it Pogostick Man}, from Wikipedia contributors (2011), ``Old Frisian". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Old_Frisian&oldid=461768402}
...
\paragraph{West Germanic to Old Low Franconian}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Old Dutch". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Old_Dutch&oldid=588537679}; and Wikipedia contributors (2014), ``Germanic umlaut". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Germanic_umlaut&oldid=602634218}
...
\subparagraph{Old Low Franconian to Middle Dutch}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Middle Dutch". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Middle_Dutch&oldid=602536434}; and Wikipedia contributors (2014), ``Hieronymous Bosch". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Hieronymus_Bosch&oldid=601403790}
...
\subparagraph{Middle Dutch to Modern Dutch}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Dutch Phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dutch_phonology&oldid=602553868}; and Wikipedia contributors (2014), ``Hard and soft G in Dutch". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Hard_and_soft_G_in_Dutch&oldid=594028971}
...
\subparagraph{Modern Dutch to Polder Dutch Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Dutch Phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dutch_phonology&oldid=602553868}

\ipa{Ei \oe y 2u} \change\ \ipa{ai ay au}\\
\ipa{e: \o: o:} \change\ \ipa{Ei \oe y  Ou}

\subparagraph{Belgian and Netherlandish Dutch Monophthongization}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Dutch Phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dutch_phonology&oldid=602553868}

\ipa{Ei \oe y Ou} \change\ \ipa{E: \oe: O:}

\paragraph{Middle High German to Standard German}{\it Pawe\l\ Ciupak}, from Behr, Hans-Joahim, Ingrid Bennewitz, {\it et al.} (2004). {\it Die Bamberg (BA)-Braunschweiger (BS) Grammatik des Alt- und Mittelhochdeutschen im Internet}. \url{https://www.tu-braunschweig.de/Medien-DB/germanistik/babs260304.pdf}; Kundert, Ursula (2009). {\it Einf\"{u}hrung in das Mittelhochdeutsche}. \url{http://www.germsem.uni-kiel.de/mediaevistik/materialien/Kundert_Mhdreader_090330.pdf}; and Anonymous (2009). {\it Mittelhochdeutsche Kurzgrammatik}. \url{https://www.uni-frankfurt.de/47053276/Kurzgrammatik-HA_09_2009.pdf}
...
V \change\ V\ipa{:} / analogic in some cases\\
\ipa{@} \change\ \O\ / unstressed, but not in every case\\
\O\ \change\ \ipa{@} / M_\ipa{r}\% (I don't know what Mr. Ciupak means by $\langle$M$\rangle$)

\paragraph{High German Cosonant Shift and Umlaut}{\it Pogostick Man}, from \url{http://en.wikipedia.org/wiki/High_German_consonant_shift}; and Wikipedia contributors (2014), ``Germanic umlaut". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Germanic_umlaut&oldid=602634218}
...
\paragraph{West Germanic to Old Low German}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Old Saxon phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Old_Saxon_phonology&oldid=598609310}; Wikipedia contributors (2014), ``Old Saxon". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Old_Saxon&oldid=598557577}; and Wikipedia contributors (2014), ``Germanic umlaut". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Germanic_umlaut&oldid=602634218}
...
\subsubsection{Common Germanic to Proto-Norse}{\it Herr Dunkel}, from personal observations

\tab {\it NB: This list is incomplete and not in chronological order.}

\{\ipa{\ae,e:}\} \change\ \ipa{a:}\\
\ipa{au ai} \change\ \ipa{o: e:} / when unstressed\\
\ipa{z} \change\ \ipa{\;R}\\
\ipa{u} \change\ \ipa{o} / ``before an approximant?"\\
\ipa{w:} \change\ \ipa{g\super w:}\\
\{\ipa{gj,j:}\} \change\ \ipa{\textbardotlessj:}\\
\ipa{an} \change\ \ipa{a:} / _C (conjectural)\\
\ipa{o:n} \change\ \ipa{an} / _\#\\
\ipa{w} \change\ \O\ / _\ipa{u}\\
\ipa{w} \change\ \O\ / _\ipa{a} (``some other conditions because (\textbf{*me\ipa{D}waz \textgreater\ me\ipa{D}wa\ipa{\;R}}")\\
\ipa{w} \change\ \O\ / _\ipa{o} (``probably something else since we have `\textbf{\'{O}\ipa{D}inn}' but `\textbf{vo\ipa{D}i}'")\\
\ipa{B} \change\ \O\ / V_B (conjectural)\\
\ipa{i} \change\ \ipa{e} / \#(C\textellipsis)_CC\\
\ipa{we} \change\ \ipa{i} (conjectural)

\paragraph{Proto-Norse to Icelandic}{\it Wattmann}
...
V[+nas] \change\ V[-nas]\\
\ipa{y(:)} \change\ \ipa{i(:)}\\
\ipa{i: u:} \change\ \ipa{i u} \change\ \ipa{I Y}\\
\ipa{O(:)} \change\ \ipa{\o}\\
\ipa{a: e: o:} \change\ \ipa{au je ou}\\
\ipa{E: \o:} \change\ \ipa{E: ai}\\
S\ipa{:} \change\ \ipa{\super h}S / when stressed\\
\ipa{g} \change\ \ipa{G} / V_V\\
S[-voiced] S[+voiced] \change\ S\ipa{\super h} S[-voiced]\\
V \change\ V\ipa{:} / _C ! _C\ipa{:}\\
A \change\ A[-voiced] / \#\ipa{h}_
...
\subsection{Proto-Indo-European to Proto-Indo-Aryan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Indo-Arian Language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Indo-Iranian_language&oldid=543625693}

\ipa{\'{k} \'{g} \'{g}\super H} \change\ \ipa{C \textbardotlessj\ h}\\
\ipa{k(\super w) g(\super w) g(\super w)\super H} \change\ \ipa{c \textbardotlessj\ h} / _E\\
\ipa{\textsubarch{u}} \change\ \ipa{v}\\
\{\ipa{\s{m},\s{n}}\} \change\ \ipa{a}\\
\ipa{e(:)} \change\ \ipa{a(:)}\\
\ipa{o} \change\ \ipa{a:} / in U[+open]?\\
\ipa{o} \change\ \ipa{a} \\
\ipa{o:} \change\ \ipa{a:}\\
h$_x$ \change\ \O\

\subsubsection{Proto-Indo-Aryan to Central Middle Indo-Aryan}{\it Pogostick Man}, from Shukla, Shaligram (1974), ``Phonological change and dialect variation in Middle-Indo-Aryan". In Anderson, J., and C. Jones (Eds.), {\it Historical Linguistics} II:391-401.
...
\subsubsection{Proto-Indo-Aryan to Eastern Middle Indo-Aryan}{\it Pogostick Man}, from Shukla, Shaligram (1974), ``Phonological change and dialect variation in Middle-Indo-Aryan". In Anderson, J., and C. Jones (Eds.), {\it Historical Linguistics} II:391-401.
...
\subsubsection{Proto-Indo-Aryan to Northwestern Middle Indo-Aryan}{\it Pogostick Man}, from Shukla, Shaligram (1974), ``Phonological change and dialect variation in Middle-Indo-Aryan". In Anderson, J., and C. Jones (Eds.), {\it Historical Linguistics} II:391-401.
...
\subsubsection{Proto-Indo-Aryan to Western Middle Indo-Aryan}{\it Pogostick Man}, from Shukla, Shaligram (1974), ``Phonological change and dialect variation in Middle-Indo-Aryan". In Anderson, J., and C. Jones (Eds.), {\it Historical Linguistics} II:391-401.
...
\subsubsection{Proto-Slavic to Polish}{\it Xi\textpolhook{a}dz Faust}, in \url{http://pittmirg.ovh.org/inne/psc.pdf http://pittmirg.ovh.org/inne/psc.pdf}, mainly citing mainly citing Klemensewicz {\it et al.} (1955), ''Gramatyka historyczna j\textpolhook{e}zyka polskiego'', and Dubisz and D\l ugosz-Kurczabowa (2003?), ''Gramatyka historyczna j\textpolhook{e}zyka polskiego'')
...
{\it NB: This is likely incomplete.}
...
\subparagraph{Vulgar Latin to Rhaeto-Romance}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Rhaeto-Romance languages". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Rhaeto-Romance_languages&oldid=607581179}
...
\subparagraph{Latin to Sardinian}{\it FearfulJesuit}

\tab {\it NB: This is an incomplete list}
...
\ipa{m} \change\ \O\ / _\#\\
V\ipa{:} \change\ V[-long]\\
\{\ipa{l:,ld}\} \ipa{nd} \change\ \ipa{\:d: \:n\:d} / V_V\\
\ipa{l} \change\ \ipa{r} / C_\\
\O\ \change\ V / \#_\ipa{r} / ``in Campidenese, but I can determine no rule for when the vowel was what"\\
\O\ \change\ \ipa{i} / \#_\ipa{s}C ``(Logudorese)"\\
\{\ipa{b d g}\} \change\ \O\ / V_V ``(except in Nuorese)"\\
\ipa{p t k} \change\ \ipa{B D G} / V_V ``(except in Nuorese)"\\
\ipa{v} \change\ \ipa{b} / \#_\\
\ipa{lj} \change\ \{\ipa{ts,dz}\} ``(varies)"\\
\ipa{k\super w g\super w} \change\ \ipa{p b}\\
\ipa{i} \change\ \ipa{z} / \#_V
...
\subsection{Tocharian}

\subsubsection{Proto-Indo-European to Tocharian A}{\it Dayun}

\tab {\it NB: A note on the KQ page says ``I believe that $\langle$?$\rangle$ here is either /\ipa{1}/ or /\ipa{@}/."}

\{\ipa{b,b\super H}\} \ipa{d\super H} \change\ \ipa{p t}\\
\ipa{d} \change\ \{\ipa{ts},\O\} (``the environments are not yet fully understood"; the page seems to imply that \ipa{d} \change\ \ipa{ts} was more common)\\
\ipa{\'{k} \'{g} \'{g}\super H g g\super H} \change\ \ipa{k}\\
\ipa{k\super w g\super w g\super w\super H} \change\ ``k plus labialization"\\
\ipa{t k st l n} \change\ \ipa{tS S} \{\ipa{S:,StS}\} \ipa{lj nj} / _E\\
Some other palatalizations _E not expanded upon\\
N \ipa{l} \change\ \ipa{n} \O\ / _\#\\
``[S]yllabic resonants develop prosthetic ?"\\
H \change\ \O\ / \s{R}_C\\
H \change\ \ipa{a:} / C_C\\
\ipa{i}H \change\ \ipa{ja}\\
\ipa{u}H \change\ \ipa{wa}\\
\{\ipa{e,i,u}\} \change\ ? \change\ \ipa{a(:)} `` or remain depending on complex factors"\\
\ipa{o} \change\ \ipa{a} / ! ``if there was a /u/ in the following syllable"\\
\ipa{e:} \change\ \ipa{a}\\
\{\ipa{a,o:}\} \change\ \ipa{a}\\
\ipa{a:} \change\ \ipa{a}\\
\ipa{i: u:} \change\ \ipa{i u}\\
Diphthongs \change\ monophthongs\\
? \change\ \O\ / in U[+open]\\
U\# \change\ \O\ ``with addition of ? as needed"

\subsubsection{Proto-Indo-European to Tocharian B}{\it Dayun}
...
\ipa{k\super w g\super w g\super w\super H} \change\ ``k plus labialization"\\
\ipa{t k st l n} \change\ \ipa{tS S} \{\ipa{S:,StS}\} \ipa{lj nj} / _E\\
\ipa{w} \change\ \ipa{j} / _E (sometimes)\\
Some other palatalizations _E not expanded upon\\
N \ipa{l} \change\ \ipa{n} \O\ / _\#\\
``[S]yllabic resonants develop. . .prosthetic a"\\
H \change\ \O\ / \s{R}_C\\
H \change\ \ipa{a:} / C_C\\
\ipa{i}H \change\ \ipa{ja}\\
\ipa{u}H \change\ \ipa{wa}\\
\{\ipa{e,i,u}\} \change\ ? \change\ \ipa{a(:)} `` or remain depending on complex factors"\\
\ipa{o} \change\ \ipa{e} / ! ``if there was a /u/ in the following syllable"\\
\ipa{e:} \change\ \ipa{e}\\
\{\ipa{a,o:}\} \change\ \ipa{a:}\\
\ipa{a:} \change\ \ipa{o}\\
\ipa{i: u:} \change\ \ipa{i u}\\
? \change\ \O\ / in U[+open -stress]

\clearpage

\section{Je-Tup\'{\i}-Carib}\tab As pertains to this section, the vowels given in the form $\langle$\{V$_1$/V$_2$\}$\rangle$\hspace{0pt} herein may have apparently been some sort of alternation in vowel grade or quality. Also, the names of these languages were researched on the Wikipedia; they are in many cases different from the names cited within the source papers proper.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Akw\'{a}ra}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Cocama}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Guajajara}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Guaran\'{i}}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Guarayo}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Kamayur\'{a}}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Parintint\'{i}n}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Sirion\'{o}}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Classical Tupi}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\subsubsection{Proto-Tup\'{i}-Guaran\'{i} to Urubu}{\it Pogostick Man}, from Lemle, Miriam (1971), ÒInternal ClassiÞcation of the Tupi-Guarani Linguistic FamilyÓ. In {\it Tupi Studies I}, from {\it Summer Institute of Linguistics Publications in Linguistics and Related Fields Publication Number 29}.
...
\tab (From Wikipedia contributors (2013), ``Kartvelian languages''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Kartvelian_languages&oldid=580201868}; and Wikipedia contributors (2013), ``Proto-Kartvelian language''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Kartvelian_language&oldid=574800306})

\subsection{Proto-Kartvelian to Georgian}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Kartvelian languages''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Kartvelian_languages&oldid=580201868}\\
...
\subsection{Proto-Kartvellian to Svan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Kartvelian languages''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Kartvelian_languages&oldid=580201868}\\
...
\subsection{Proto-Kartvelian to Zan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Kartvelian languages''. {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Kartvelian_languages&oldid=580201868}\\
...
\tab (From Wikipedia contributors (2014), ``Pama--Nyungan languages". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Pama%E2%80%93Nyungan_languages&oldid=605755580}, presumably citing Alpher, Barry (2004), ``Proto-Pama-Nyungan etyma". In Bowern, Claire, and Harold Koch (eds.), {\it Australian Languages: Classification and the Comparative Method})
...
\tab (From Wikipedia contributors (2013), ``Mayan languages". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Mayan_languages&oldid=583331877})

\subsection{Proto-Mayan to Ch'olan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Chujean}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Huastecan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Ixilean}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Kaqchikel-Tz'utujil}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Core K'iche'}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}

\ipa{N} \change\ \ipa{x}\\
CV\ipa{P}VC \change\ CV\ipa{P}C\\
\ipa{t\super j(')} \change\ \ipa{tS(')}

\subsection{Proto-Mayan to Mamean}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Q'anjob'alan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\subsection{Proto-Mayan to Tzeltalan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}

\ipa{q(')} \change\ \ipa{k(')}\\
\ipa{N} \change\ \ipa{n}\\
\ipa{a: e: o:} \change\ \ipa{1 i u}

\subsection{Proto-Mayan to Yucatecan}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Proto-Mayan language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Mayan_language&oldid=571518268}
...
\tab A lot of the Bantu sound changes are from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}. This book contains comparative vocabulary lists from which I have attempted to find sound changes; I make no guarantee as to their completeness or their accuracy, as there are numerous potential problems with the data and source (not to mention the guy trying to find the sound changes). Further, some names may have fallen into disuse or obsolescence; the source is from 1919, and no offense is intended from the use of the names from the source document---I welcome any corrections that may be sent to me.
...
\paragraph{British East Africa}

\subparagraph{Proto-British East Africa to Kamba}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{d} \change\ \ipa{r} / ! N_\\
\ipa{h} \change\ \O\ / V_V\\
\ipa{p b} \change\ \{\ipa{v,h}\} \ipa{v} / V_V\\
\ipa{z} \change\ \ipa{r}\\
\ipa{ts} \change\ \ipa{T}\\
V\ipa{r} \change \O\\
\ipa{wi} \change\ \ipa{uj} / C_\\
\ipa{g}V \change\ \O\ / V_\#\\
Looks like some dissimilation may have gone on where if there were two [\ipa{T}] in a word, the first one changed to [\ipa{s}]\\
\ipa{u} \change\ \ipa{w} / _\ipa{a}\#\\
\ipa{i} \change\ \O\ / \ipa{u}_\#\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\subparagraph{Proto-British East Africa to Kikuyu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{d} \change\ \ipa{r} / ! N_\\
\ipa{ki} \change\ \ipa{tS} / _V ?\\
\ipa{h} \change\ \O\ / V_V\\
\ipa{ts} \change\ \ipa{s} / \ipa{n}_ (? Some conflicting data but it might be analogical)\\
\ipa{p ts} \change\ \ipa{h T}\\
S[- voice] \change\ S[+ voice] / N_\\
\{\ipa{l,z}\} \change\ \ipa{r}\\
\ipa{i} \change\ \O\ / \ipa{u}_\#\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\subparagraph{Proto-British East Africa to Nika}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{ni} \change\ \ipa{\textltailn} / _V\\
\ipa{p} \change\ \ipa{f} / V_V\\
\ipa{d} \change\ \ipa{z} / \#_ ?\\
\ipa{k t} \change\ \{\ipa{ts,tS}\} \ipa{s} / _\ipa{i}\\
\ipa{k} \change\ \ipa{tS} / _E\#\\
N \change\ \O\ / _S[- voice]\\
\ipa{t} \change\ \ipa{h} / V_V\#\\
\ipa{\textltailn} \change\ \ipa{n} / \#_\\
\ipa{u} \change\ \ipa{w} / _\ipa{a}\#\\
\ipa{i} \change\ \O\ / _\ipa{u}\#\\
\ipa{i} \change\ \O\ / \ipa{u}_\#\\
\ipa{r} \change\ \ipa{l}\\
\ipa{uju} \change\ \ipa{wi} / _\#\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\subparagraph{Proto-British East Africa to Pokomo}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{ni} \change\ \ipa{\textltailn} / _V\\
\ipa{p b} \change\ \ipa{pf bv} / \ipa{i}_ ?\\
\ipa{p} \change\ \ipa{f} / \#_\\
S[- voice] \change\ \ipa{h} / V_V\#\\
\{\ipa{p,b}\} \change\ \ipa{w} / V_V\\
\ipa{ts} \change\ \ipa{s} / N_\\
\ipa{t} \change\ \O\ / \ipa{w}_\\
\ipa{g} \change\ \O\ / V_V\#\\
\ipa{g} \change\ \ipa{j} / V_V\\
\ipa{r} \change\ \ipa{j}\\
\ipa{s ts} \change\ \O\ \ipa{tS} / _\ipa{w}\\
\ipa{uju} \change\ \ipa{wi} / _\#\\
\ipa{u} \change\ \ipa{w} / _V\#\\
\ipa{k} \change\ \ipa{tS} / _\ipa{i}\#\\
\ipa{i} \change\ \O\ / _B\#\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\subparagraph{Proto-British East Africa to Taita}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t d} \change\ \ipa{tS dZ} / _\ipa{i}\\
\ipa{d} \change\ \ipa{r} / \#_\\
\ipa{p} \change\ \ipa{f}\\
\ipa{ts} \change\ \ipa{tS} / _\ipa{i}\\
\ipa{z} \change\ \ipa{(d)Z} / _\ipa{i}\\
\ipa{ts dz} \change\ \ipa{s z} / N_\\
Stem-initial consonants seem to have voiced, but not prefix-initial ones\\
\ipa{t s} \change\ \{\ipa{s,S}\} \ipa{S} / _\ipa{i}\\
\ipa{t} \change\ \ipa{d} / V_V\#\\
\ipa{ts} \change\ \ipa{t} / _\ipa{w}\\
\ipa{ts} \change\ \O\ / \ipa{w}_\\
\ipa{ts dz} \change\ \{\ipa{s,tS}\} \{\ipa{z,dZ}\} ?\\
S[- voice] \change\ S[+ voice] / N_\\
V \change\ \O\ / V_\#\\
\ipa{ndZ} \change\ \ipa{\textltailn}\\
\ipa{r} \change\ \ipa{l}\\
\ipa{i} \change\ \O\ / \ipa{u}_\#\\
\ipa{si} \change\ \ipa{S} / _B\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\subparagraph{Proto-British East Africa to Taveita}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\{\ipa{p,b}\} \change\ \ipa{w} / V_V\\
\ipa{p} \change\ \ipa{f}\\
\ipa{g} \change\ \{\ipa{G,j}\} / V_V\\
\ipa{si} \change\ \ipa{S} / _B\\
\ipa{t s} \change\ \ipa{s S} / _\ipa{i}\\
\ipa{ts} \change\ \ipa{t} / _\ipa{w}\\
\ipa{ts} \change\ \ipa{s} / \#_\\
S[- voice] \change\ S[+ voice] / N_\\
\ipa{s} \change\ \ipa{h} / \#_\\
\ipa{ua} \change\ \ipa{au} / _\# ?\\
\ipa{r} \change\ \ipa{l}\\
\ipa{a} \change\ \ipa{i} / \ipa{w}_\#\\
\ipa{u} \change\ \ipa{w} / _V\#\\
A lot of intervocalic voicing, but not every item---not sure if there's conditioning or if it's something with the data

\paragraph{Kilimanjaro}

\subparagraph{Proto-Kilimanjaro to Chaga}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\{\ipa{ts,dz}\} \change\ \ipa{z} / V_V\\
\ipa{ts dz} \change\ \ipa{s z} / N_\\
\ipa{s} \change\ \ipa{z} / N_ ?\\
\ipa{tS} \change\ \ipa{S} / \#_ (? I'd expect \ipa{dZ} \change\ \ipa{Z} / \#_ as well)\\
\ipa{h} \change\ \O\ / V_V\\
\ipa{k} \change\ \ipa{j} / E_B ?\\
\ipa{S} \change\ \ipa{dZ} / N_\\
\ipa{k} \change\ \ipa{h} / \{N,V\}_V\\
\ipa{p} \change\ \ipa{b} / N_\\
\ipa{p} \change\ \ipa{h}\\
\ipa{f} \change\ \{\ipa{f},\O\} / V_V\\
\ipa{w} \change\ \O\ / \#_\ipa{u}\\
\ipa{s} \change\ \ipa{r} / V_V\\
\ipa{n} \change\ \O\ / _\ipa{s}\\
\ipa{t} \change\ \{\ipa{h,d}\} / V_V\\
\ipa{l} \change\ \ipa{d} / \ipa{n}_\\
\O\ \change\ \ipa{d} / \ipa{n}_\ipa{r} ?\\
\ipa{i} \change\ \O\ / _V ?\\
Looks like something may have happened where an obstruent voiced following a nasal if they did not share a POA

\subparagraph{Proto-Kilimanjaro to Paregweno}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\O\ \change\ \ipa{b} / \ipa{m}_\ipa{w}\\
\ipa{wa} \change\ \ipa{o} ?\\
\ipa{a} \change\ \ipa{o} / \ipa{w}_ ?\\
\ipa{w} \change\ \O\ / B_B\\
\ipa{u} \change\ \ipa{w} / _V\\
\ipa{p} \change\ \O\ / V_V\\
\{\ipa{t,d}\} \change\ \ipa{r} / V_V\\
\ipa{k} \change\ \ipa{g} / \{N,V\}_V\\
\ipa{l} \change\ \ipa{r}\\
\ipa{d} \change\ \ipa{r} / \#_V ?\\
\ipa{S Z} \change\ \ipa{s z} / N_\\
\ipa{s} \change\ \ipa{z} / N_\\
\ipa{g} \change\ \ipa{G} / \{N,V\}_V\\
\ipa{oi} \change\ \ipa{OE} / _\#\\
\ipa{s} \change\ \ipa{z} / \#_ ? \$_ ? Possibly more, but this seems to be the most consistent phone to voice in this situation\\
\ipa{Ng} \change\ \ipa{\textltailn} / _\ipa{i}\\
\ipa{l} \change\ \ipa{d} / \ipa{n}_\\
\ipa{u} \change\ \O\ / V_\# ?\\
S[- voice] \change\ \ipa{h} / V_V\# (possibly sporadic)

\paragraph{Nyanza}

\subparagraph{Proto-Nyanza to Kiguzii}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{Nk} \change\ \ipa{s} / _\ipa{i} ?\\
\ipa{k\super w} \change\ \ipa{p}\\
\ipa{p k s} \change\ \ipa{b g r} / V_V\\
\ipa{Nk\super w} \change\ \ipa{\textltailn} / \#_\ipa{i}\\
\ipa{E} \change\ \O\ / \ipa{i}_\#\\
C[- voice] \change\ C[+ voice] / N_

\subparagraph{Proto-Nyanza to Kikoria}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{g} \change\ \ipa{h} / _\ipa{i}E\\
\ipa{s} \change\ \ipa{r} / V_V\#\\
\ipa{i}E \change\ \ipa{i:} / _\#\\
\ipa{Nk\super w} \change\ \ipa{n} / \#_\ipa{i}\\
\ipa{k\super w g\super w} \change\ \ipa{k} \{\ipa{gw, hw}\}

\subparagraph{Proto-Nyanza to Luganda}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{ki} \change\ \{\ipa{ki,tS}\} / _V\\
\ipa{n} \change\ \{\ipa{l,r}\} / V_V (sporadic? allophonic?)\\
\ipa{n} \change\ \O\ / _\ipa{d\super j}\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{g} \change\ \O\ / \#VN_\\
\ipa{b} \change\ \ipa{w} / V_V\\
\ipa{f} (\change\ \ipa{h}?) \change\ \ipa{s} / _\ipa{i}\\
V \change\ V\ipa{:} / _V\#\\
V \change\ \O\ / V\ipa{:}_\\
\ipa{h} \change\ \O\ / V_V\\
\ipa{k\super w} \change\ \ipa{f}\\
\ipa{h} \change\ \ipa{w} / V_B ?\\
\ipa{we} \change\ \ipa{i} / _\#\\
\ipa{e} \change\ \ipa{E} / _\#\\
C[- voice] \change\ C[+ voice] / N_\\
N \change\ N[+ same POA] / _C ! _\ipa{w}\\
C\ipa{:} \change C\\
\ipa{n} \change\ \ipa{m} / _\ipa{w}

\subparagraph{Proto-Nyanza to Lugishu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

Possible dissimilatory process where \ipa{n} \change\ \ipa{l} / _V\ipa{n}?\\
\ipa{t} \change\ \ipa{s} / V_\ipa{i}\#\\
\ipa{t} \change\ \ipa{r} / V_V\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{gi} \change\ \ipa{j} / _E\\
\ipa{(N)k} \change\ \ipa{s} / _\ipa{i} (?)\\
\ipa{k\super w} \change\ \ipa{s} / \#_\ipa{i}\\
\ipa{k\super w} \change\ \ipa{p} / \#N_\\
\ipa{k\super w} \change\ \{\ipa{xw,f}\}\\
\ipa{d} \change\ \ipa{l} ?\\
\ipa{k} \change\ \{\ipa{x,g}\} / V_V\\
\ipa{i} \change\ \O\ / V_\#\\
C[- voice] \change\ C[+ voice] / N_

\subparagraph{Proto-Nyanza to Lukonde}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{k} \change\ \ipa{g} / \#_ (seemingly in one prefix)\\
\ipa{s} \change\ \ipa{z} / V_V\#\\
\ipa{t} \change\ \ipa{s} / V_\ipa{i}\#\\
\ipa{t\super j d\super j} \change\ \{\ipa{ts,tS}\} \{\ipa{dz,dZ}\}\\
\ipa{gi} \change\ \{\ipa{h,j}\} / _E\\
\ipa{Nk} \change\ \ipa{nz} / _\ipa{i}\\
\ipa{k} \change\ \ipa{tS} / _\ipa{i}\\
\ipa{k\super w} \change\ \{\ipa{p,b}\} / \#N_\\
\ipa{k\super w} \change\ \{\ipa{xw,f}\}

\subparagraph{Proto-Nyanza to Lunyara}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{k} \change\ \ipa{S} / _\ipa{i}\#\\
\ipa{k} \change\ \ipa{(t)s} / _\ipa{i}\\
\ipa{Nk} \change\ \ipa{s} / _\ipa{i} ?\\
\ipa{gi} \change\ \ipa{j} / _E\\
\ipa{b} \change\ \O\ / _\ipa{w}\\
\ipa{t} \change\ \ipa{s} / V_\ipa{i}\#\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{k\super w g\super w} \change\ \{\ipa{f,x}\} \ipa{w:}\\
\ipa{d} \change\ \ipa{l} ?\\
\ipa{k t} \change\ \ipa{x} \{\ipa{d,r}\} / V_V\\
\ipa{t} \change\ \ipa{d} / \#_\\
C[- voice] \change\ C[+ voice] / N_

\subparagraph{Proto-Nyanza to Luwanga}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t} \change\ \ipa{s} / V_\ipa{i}\#\\
\ipa{g} \change\ \ipa{G} / \ipa{i}_\ipa{i}\\
\ipa{t} \change\ \ipa{r} / \{\#,V\}_V\\
\ipa{t\super j d\super j} \change\ \ipa{ts dz}\\
\ipa{Nk} \change\ \ipa{s} / _\ipa{i} ?\\
\ipa{k} \change\ \ipa{S} / _\ipa{i}\\
\ipa{k} \change\ \ipa{x} / _\ipa{E}\\
\ipa{k\super w} \change\ \ipa{S} / \#_\ipa{i}\\
\ipa{k\super w g\super w} \change\ \{\ipa{f(w),xw}\} \ipa{w:}\\
\ipa{d} \change\ \ipa{r} / ! \ipa{n}_\\
\ipa{k t} \change\ \ipa{x d} / V_V\\
\ipa{u} \change\ \ipa{w} / _V\#\\
C[- voice] \change\ C[+ voice] / N_

\subparagraph{Proto-Nyanza to Luziba}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{S Z} ?\\
\ipa{nd\super j} \change\ \ipa{\textltailn}\\
\ipa{f} (\change\ \ipa{h}?) \change\ \ipa{s} / _\ipa{i}\\
\ipa{k\super w} \change\ \ipa{f}\\
\ipa{s} \change\ \ipa{S} / \ipa{i}_ (either this or some consonant harmony probably started to work)\\
\ipa{a e} \change\ \ipa{o E} / _\#\\
C[- voice] \change\ C[+ voice] / N_\\
\ipa{l} \change\ \ipa{r}\\
\ipa{b} \change\ \ipa{m} / _VN ?\\
C\ipa{:} \change\ C\\
N \change\ N[+ same POA] / _C

\subparagraph{Proto-Nyanza to Olukonjo}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}
...
\ipa{p} \change\ \ipa{h}\\
C\ipa{:} \change\ C\\
\ipa{\textltailn} \change\ \ipa{n} / _\ipa{i} (No, this is not backwards)\\
\ipa{e} \change\ \ipa{E}\\
\ipa{u} \change\ \ipa{w} / _V\#\\
\ipa{z} \change\ \ipa{r}\\
\ipa{t\super j d\super j} \change\ \ipa{t d}\\
\ipa{d} \change\ \ipa{z} / V_VCV\# ?\\
\ipa{ai} \change\ \ipa{E}\\
\ipa{wa} \change\ \ipa{o} / _\#\\
\ipa{g} \change\ \ipa{G} / V_V\\
Somehow, *\ipa{l} *\ipa{r} seem to have become flip-flopped with respect to their reflexes in Urunyorow\\
N \change\ N[+ same POA] / _C ! _\ipa{w}

\subparagraph{Proto-Nyanza to Oruhoma}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

C\ipa{:} \change\ C\\
\ipa{k\super w} \change\ \ipa{p}\\
(\ipa{k\super w} \change) \ipa{p} \change\ \ipa{f} / ! \ipa{m}_\\
\ipa{t\super j d\super j} \change\ \ipa{(t)s}? \ipa{z}\\
\ipa{k Ng} \change\ \ipa{tS \textltailn} / _E\\
\ipa{b} \change\ \O\ / _\ipa{w}\\
\ipa{s} \change\ \ipa{z} / \ipa{n}_ (and V_V?)\\
\ipa{ts} \change\ \ipa{(d)z} / V_V\\
\ipa{h} \change\ \ipa{s} / _\ipa{i}V\\
\ipa{l} \change\ \ipa{r}\\
\ipa{e} \change\ \ipa{i}\\
\ipa{ai} \change\ \ipa{E} / _\#\\
\ipa{ai} \change\ \ipa{E:}\\
...
\subparagraph{Proto-Nyanza to Rugungu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{o u} \change\ \ipa{u i} (sometimes?)\\
\ipa{t} \change\ \ipa{tS} / _\ipa{i} (maybe only word-finally?)\\
V \change\ \O\ / \#_\\
\ipa{b} \change\ \{\ipa{v,w}\} / V_V\\
\ipa{\textltailn} \change\ \ipa{n} / _\ipa{i}\\
\ipa{n} \change\ \ipa{m} / _\ipa{w}\\
E \change\ \ipa{i} / _\#\\
\ipa{e} \change\ \ipa{E}\\
\ipa{Ng} \change\ \ipa{\textltailn} / _E\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{z} \change\ \ipa{l}\\
\ipa{r} \change\ \ipa{l}\\
V \change\ \O\ / V_\#\\
...
\subparagraph{Proto-Nyanza to Rukyopi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{o u} \change\ \ipa{u i} (sometimes?)\\
VC\ipa{:} \change\ V\ipa{:}C\\
\ipa{k\super w} \change\ \ipa{p}\\
(\ipa{k\super w} \change) \ipa{p} \change\ \ipa{f} / ! \ipa{m}_\\
...
\subparagraph{Proto-Nyanza to Rututsi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{k} \change\ \ipa{ts} / _\ipa{i}\\
\ipa{d\super j} \change\ \ipa{z} / \ipa{n}_\\
\ipa{b} \change\ \ipa{m} / _VN ?\\
\ipa{b ts} \change\ \ipa{w dz} / V_V\\
\ipa{e} \change\ \ipa{E} / _\#\\
\ipa{l} \change\ \ipa{r}\\
\ipa{u} \change\ \ipa{w} / _V\#\\
C\ipa{:} \change\ C\\
...
\subparagraph{Proto-Nyanza to Urukaragwe}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{k} \change\ \ipa{ts} / _\ipa{i}\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{ns} \change\ \ipa{z} / \#V_\\
\ipa{ns} \change\ \ipa{dz}\\
\ipa{r} \change\ \ipa{l}\\
\ipa{d} \change\ \ipa{l} / \$_\\
\ipa{b ts} \change\ \ipa{v dz} / V_V\\
\ipa{v} \change\ \O\ / \ipa{a}_\ipa{o}\#\\
\ipa{f} \change\ \ipa{h} (sometimes?)\\
\ipa{k\super w} \change\ \ipa{f}\\
\ipa{e} \change\ \ipa{E} / _\#\\
C\ipa{:} \change\ C\\
C[- voice] \change\ C[+ voice] / N_\\
...
\subparagraph{Proto-Nyanza to Urukerebe}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}
...
\ipa{f} \change\ \ipa{h} (sometimes?)\\
\ipa{k\super w} \change\ \ipa{f}\\
\ipa{u} \change\ \ipa{w} / _E\\
\ipa{n d} \change\ \ipa{l r} / V_V (seems to have happened at least once)\\
S[- voice] \change\ S[+ voice] / N_\\
\ipa{ai} \change\ \ipa{E} / _C\\
\ipa{e} \change\ \ipa{E} / _\#\\
\ipa{l} \change\ \ipa{r}\\
C\ipa{:} \change\ C\\
N \change\ N[+ same POA] / _C

\subparagraph{Proto-Nyanza to Urunya-Ruanda}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j} \change\ \ipa{ts} (maybe \change\ \ipa{s} / _VCV(C)\# ?)\\
\ipa{k} \change\ \ipa{tS} / _\ipa{i}\\
\ipa{ns} \change\ \ipa{ts}\\
\ipa{d\super j} \change\ \ipa{z} / \ipa{n}_\\
\ipa{g} \change\ \ipa{r} / V_VCV\# (I'm not entirely sure of the conditioning here)\\
\ipa{g} \change\ \ipa{G} / \ipa{b}_\\
\ipa{a} \change\ \ipa{o} / _\ipa{i}\\
\ipa{i} \change\ \O\ / V_\\
\ipa{e} \change\ \ipa{i} / \#_\\
\ipa{e} \change\ \ipa{i} / _\#\\
V \change\ \O\ / V_\#\\
\ipa{mu} \change\ \ipa{mwE} / _\#\\
\ipa{l} \change\ \ipa{r}\\
N \change\ N[+ same POA] / _C

\subparagraph{Proto-Nyanza to Urunyoro}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{k\super w} \change\ \ipa{p}\\
\ipa{p} \change\ \ipa{h} / ! \ipa{m}_\\
\ipa{t} \change\ \ipa{tS} / _\ipa{w}\\
\ipa{b d} \change\ \ipa{w r} / V_V\\
\ipa{w} \change\ \O\ / \ipa{b}_\\
\ipa{d\super j} \change\ \ipa{dZ} / N_\\
\ipa{e} \change\ \ipa{i}\\
\ipa{Ng} \change\ \ipa{\textltailn} / _E\\
C[- voice] \change\ C[+ voice] / V_V\#\\
\ipa{z} \change\ \ipa{l} / V_V ?\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{a} \change\ \O\ / _\ipa{i}\\
Somehow, *\ipa{r} *\ipa{l} seem to ahve become flip-flopped with respect to their reflexes in Olukonjo\\
N \change\ N[+ same POA] / _C ! _\ipa{w}

\subparagraph{Proto-Nyanza to Urutoro}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{b} \change\ \ipa{w} / V_V\\
\ipa{t} \change\ \ipa{tS} / _\ipa{w} ?\\
\ipa{k\super w} \change\ \ipa{p}\\
(\ipa{k\super w} \change) \ipa{p} \change\ \ipa{f} / ! \ipa{m}_\\
\ipa{t\super j} \change\ \ipa{tS} / _(V)\ipa{i}? _V[+ high]?\\
\ipa{t\super j} \change\ \ipa{s}\\
\ipa{Ng} \change\ \ipa{\textltailn} / _E\\
\ipa{i} \change\ \ipa{j} / _V\#\\
\ipa{l} \change\ \ipa{r}\\
\ipa{e} \change\ \ipa{i}\\
\ipa{(a)i} \change\ \ipa{E} / _\#\\
\ipa{a} \change\ \ipa{E} / _\ipa{i}\\
VV \change\ V\ipa{:} / _\#

\paragraph{Upper Rufiji}

\subparagraph{Proto-Upper Rufiji to Bena}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t} \change\ \ipa{h} / \ipa{n}_ (may have happened for other voiceless stops)\\
\ipa{t\super j d\super j} \change\ \ipa{s z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \{\ipa{ts,tS}\} \{\ipa{dz,dZ}\} ?\\
\ipa{s} \change\ \ipa{h}\\
C[- voice] \change\ C[+ voice] / V_V\\
\ipa{w} \change\ \O\ / V_V (possibly lengthening the first vowel?)

\subparagraph{Proto-Upper Rufiji to Gangi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{ts dz} ?\\
\ipa{u i} \change\ \ipa{w j} / _V\\
\ipa{E} \change\ \ipa{a} / \ipa{w}_\#\\
\ipa{j} \change\ \O\ / \ipa{k}_\\
There may be some voicing dissimilation going on if the same consonant appears twice in the root (\textit{e.g.}, *\textit{kuku} \change\ \textit{guku})

\subparagraph{Proto-Upper Rufiji to Hehe}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{s} \change\ \ipa{h} / V\$_ (root-initial after a vowel)\\
S[- voice] \change\ \{\ipa{h},\O\} / N_ (occasionally it voices but that seems to have only happened in a handful of cases)\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{u i} \change\ \ipa{w j} / _V\\
\ipa{E} \change\ \ipa{i} / _\#\\
The first consonant of a root tends to voice if voiceless, though this appears like it might have been blocked after a nasal\
\ipa{g} \change\ \O\ / _\ipa{w}\\
\ipa{kj} \change\ \ipa{tS}\\
\ipa{l} \change\ \ipa{d} / \ipa{n}_

\subparagraph{Proto-Upper Rufiji to Pogoro}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \{\ipa{ts,tS}\} \{\ipa{dz,dZ}\} / N_\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{k g} \change\ \ipa{tS dZ} / _\ipa{i}\\
C[- voice] \change\ C[+ voice] / N_\\
*\ipa{\textltailn} seems to have become \ipa{n} sometimes\\
N \change\ \O\ / \#_\{\ipa{s,z}\}\\
\ipa{kj} \change\ \ipa{tS}\\
\ipa{v} \change\ \ipa{w} ?

\subparagraph{Proto-Upper Rufiji to Sango}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{nt\super j nd\super j} \change\ \{\ipa{\textltailn,ns}\} \{\ipa{\textltailn,nz}\}\\
\ipa{t\super j d\super j} \change\ \{\ipa{s,tS}\} \{\ipa{z,dZ}\} ?\\
\ipa{k} \change\ \{\ipa{s,S,\c{c},x}\} / V_\ipa{i}\\
\ipa{k} \change\ \ipa{x}\\
\O\ \change\ V / \#_NC (typically \ipa{i})\\
S[- voice] \change\ \ipa{h} / \ipa{n}_ (*\ipa{mp} remains)\\
\ipa{w} \change\ \ipa{v}\\
\ipa{u i} \change\ \ipa{w j} / _V\\
\ipa{kj} \change\ \{\ipa{\c{c},tS}\}\\
There may be some voicing dissimilation going on if the same consonant appears twice in the root (\textit{e.g.}, *\textit{kuku} \change\ \textit{guku})
...
\paragraph{Usagara-Ugogo}

\subparagraph{Proto-Usagara-Ugogo to Dzalamo}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{n}\{\ipa{t\super j,d\super j}\} \change\ \ipa{\textltailn} / _\ipa{i}\\
\ipa{d\super j} \change\ \ipa{dZ} / \#_ (not sure if \ipa{t} \change\ \ipa{tS} here)\\
\ipa{d\super j} \change\ \ipa{z}\\
S[- voice] \change\ \ipa{h} / N_V(N)CV\# (this is sort of a guess at the conditioning; a few voiceless stops seem not to have lenited)\\
\ipa{g} \change\ \ipa{dz} / \#N_\ipa{i} ?\\
\ipa{wE} \change\ \ipa{O} / _\# ?

\subparagraph{Proto-Usagara-Ugogo to Gogo}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

C[- voice] \change\ C[+ voice] / N_\\
\ipa{d\super j} \change\ \ipa{z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{ts}? \ipa{dz}\\
\ipa{b} \change\ \O\ / _\ipa{v}\\
\ipa{k} \change\ \ipa{tS} / _\ipa{i} (presumably \ipa{g} \change\ \ipa{dZ} in these conditions too)\\
\ipa{g} \change\ \ipa{z} / \#N_\ipa{i} ?\\
\ipa{r} \change\ \ipa{l}\\
\ipa{mj} \change\ \ipa{\textltailn}  (/ \#_ ?) ?\\
\ipa{E} \change\ \ipa{a} / \ipa{w}_\# ?

\subparagraph{Proto-Usagara-Ugogo to Irangi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{g} \change\ \O\ / V_V\\
\ipa{n}\{\ipa{t\super j,d\super j}\} \change\ \ipa{\textltailn} / \#_\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ} / \ipa{n}_\\
\ipa{b} \change\ \O\ / _\ipa{v}\\
V \change\ \O\ / V_\#\\
\ipa{z} \change\ \ipa{r} / V_V\\
\ipa{v} \change\ \ipa{b} / \#\ipa{m}_\\
\ipa{u} \change\ \ipa{w} / _V

\subparagraph{Proto-Usagara-Ugogo to Kaguru}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

S[- voice] \change\ S[+ voice] / N_\\
\ipa{k} \change\ \ipa{x} / \{N,V\}_V\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ} / \ipa{n}_\\
\ipa{d\super j} \change\ \ipa{d} / \#_ ?\\
\ipa{t\super j d\super j} \change\ \ipa{s z}\\
\ipa{b} \change\ \O\ / _\ipa{v}\\
\ipa{g} \change\ \ipa{j} / E_E\\
\ipa{in} \change\ \ipa{\textltailn} / \$_V

\subparagraph{Proto-Usagara-Ugogo to Kami}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{n}\{\ipa{t\super j,d\super j}\} \change\ \ipa{\textltailn} / \#_\\
\ipa{d\super j} \change\ \ipa{z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{ts dz}\\
S[- voice] \change\ \ipa{h} / N_V(N)CV\#\\
\ipa{f} \change\ \ipa{v} / N_\\
\ipa{k} \change\ \ipa{tS} / \#_V\\
Looks like some metathesis might have happened; Kami has \textit{twaga} where the others have \textit{tagwa}\\
\ipa{g} \change\ \ipa{z} / \#N_\ipa{i} ?\\
\ipa{in} \change\ \ipa{\textltailn} / \$_V\\
\ipa{u} \change\ \ipa{O} / _\#\\
\ipa{wE} \change\ \ipa{O} / _\# ?

\subparagraph{Proto-Usagara-Ugogo to Southern Sagara}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{s (d)z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{ts}? \ipa{dz}\\
\ipa{s} \change\ \ipa{h} / when the first consonant in the root\\
\ipa{f} \change\ \ipa{v} / N_\\
\ipa{b} \change\ \O\ / _\ipa{v}\\
\ipa{b} \change\ \ipa{w} / V_V
...
\subparagraph{Proto-Usambara to Bondei}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{S} \change\ \ipa{s} / _\ipa{w}\\
\ipa{w} \change\ \O\ / \ipa{u}_V\#\\
\ipa{g} \change\ \ipa{j} / E_E\\
\ipa{S} \change\ \ipa{s} / _V\#\\
\ipa{ts dz} \change\ \ipa{s z} / ! N_\\
\ipa{l}$_1$ \ipa{l}$_2$ \change\ \ipa{l} \O\ / V_V (I'm assuming one of these is *\ipa{r} and one is *\ipa{l}, but I'm not sure which one's which)\\
\ipa{r} \change\ \ipa{l}

\subparagraph{Proto-Usambara to Kimrima}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{u} \change\ \ipa{w} / \#C_V\\
\ipa{l} \change\ \ipa{r}\\
\ipa{ts dz} \change\ \ipa{tS dZ} / _\ipa{i}\\
\ipa{p} \change\ \ipa{h} / V_V\\
\ipa{l}\textellipsis\ipa{l} \change\ \ipa{l}\textellipsis\O

\subparagraph{Proto-Usambara to Shambara}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{r} \change\ \ipa{l}\\
\O\ \change\ \ipa{u} / \#\ipa{m}_\$ ! _\ipa{w}\\
\ipa{w} \change\ \O\ / \ipa{u}_V\#\\
\ipa{s} \change\ \ipa{S} / _\ipa{i}\\
\ipa{s} \change\ \ipa{S} / \ipa{i}_ ! _\#\\
\ipa{g} \change\ \ipa{G} / V_V\\
\ipa{ts dz} \change\ \ipa{tS dZ} / N_\\
\ipa{ts dz} \change\ \ipa{s z}\\
\ipa{m} \change\ \ipa{N} / _\ipa{w}

\subparagraph{Proto-Usambara to Zigula}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}
...
\paragraph{Wunyamwezi}

\subparagraph{Proto-Wunyamwezi to Kinyaturu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{b} \change\ \ipa{v} / V_V\\
\ipa{z} \change\ \ipa{d} / \ipa{n}_\\
V\ipa{r} \change\ V\ipa{:}\\
\ipa{n} \change\ \O\ / _\{\ipa{t\super j,d\super j,s}\}\\
\ipa{k} \change\ \ipa{j} / N_E ?\\
\ipa{k g} \change\ \ipa{x G} / V_E\\
\ipa{k} \change\ \ipa{g} / V_V\#\\
S[- voice] \change\ S[+ voice] / N_\\
\ipa{t\super j d\super j} \change\ \ipa{t d} / _\ipa{i} ?\\
\ipa{t\super j d\super j} \change\ \ipa{s z} ?\\
\ipa{s} \change\ \ipa{h} / V_V ?\\
\ipa{o} \change\ \ipa{a} / \#_ ?\\
\ipa{o} \change\ \ipa{wE} / _\# ?

\subparagraph{Proto-Wunyamwezi to Kisukuma}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{\textltailn} \change\ \ipa{n}\\
\ipa{w} \change\ \O\ / \ipa{b}_\\
\ipa{s} \change\ \ipa{z} / V\$_V\\
\ipa{b d} \change\ \ipa{w z} / V_V\\
\ipa{si} \change\ \ipa{S} / _V\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ} / _\ipa{i} ?\\
\ipa{t\super j d\super j} \change\ \ipa{ts dz}\\
\ipa{n} \change\ \O\ / _\ipa{tS}\\
\ipa{g} \change\ \ipa{z} / V_E\\
\ipa{g} \change\ \O\ / \ipa{N}_\ipa{w}\\
S[- voice] \change\ \ipa{h} / N_\\
\ipa{p} \change\ \ipa{h} / V_V\#\\
V \change\ \O\ / V_\#\\
\ipa{n} \change\ \O\ / _\ipa{s}\\
\ipa{t} \change\ \ipa{s} / _\ipa{i}\\
...
\subparagraph{Proto-Wunyamwezi to East Nyamwezi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{\textltailn} \change\ \ipa{n}\\
\ipa{p} \change\ \ipa{h}\\
\ipa{b d z} \change\ \ipa{v z l} / V_V\\
S[- voice] \change\ \ipa{h} / N_\\
\{\ipa{t\super j,d\super j}\} \change\ \ipa{z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{g} \change\ \ipa{dZ} / V_\ipa{i}\#\\
\ipa{t} \change\ \ipa{s} / _\ipa{i}\\
\ipa{t} \change\ \ipa{l} / V\$_V\\
\ipa{w} \change\ \ipa{v}\\
\ipa{n} \change\ \O\ / _\ipa{s}\\
S[- voice] \change\ \ipa{h} / \#_\\
\ipa{a} \change\ \ipa{E} / _(C)\ipa{E}\\
\ipa{p k} \change\ \ipa{h g} / V_V\#\\
\ipa{u} \change\ \ipa{w} / _V\#\\
\ipa{k} \change\ \ipa{g} / \#\ipa{k}V_V (? dissimilation?)\\
\{\ipa{E,e}\} \change\ \ipa{i} / _\#

\subparagraph{Proto-Wunyamwezi to West Nyamwezi}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{p} \change\ \ipa{f} ?\\
\ipa{f} \change\ \ipa{v} / \#_\\
\ipa{S} \change\ \ipa{s}\\
\ipa{n} \change\ \O\ / _C[+ fricative]\\
\{\ipa{t\super j,d\super j}\} \change\ \ipa{z} / \ipa{n}_\\
\ipa{d\super j} \change\ \ipa{j} ?\\
\ipa{k} \change\ \ipa{g} / \#\ipa{k}V_V (? dissimilation?)\\
\ipa{u i} \change\ \ipa{w j} / _V\\
\ipa{l} \change\ \ipa{n} / V_V\#

\subparagraph{Proto-Wunyamwezi to Shisumbwa}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}
...
\ipa{s} \change\ \ipa{r} / V_V\#\\
\ipa{si} \change\ \ipa{S} / _V\\
\{\ipa{d,s}\} \change\ \ipa{z} / V_V\\
\ipa{t} \change\ \{\ipa{tS,s}\} / _\ipa{i}\\
\ipa{g} \change\ \ipa{z} / V_E\\
\ipa{k} \change\ \ipa{S} / _\ipa{i}\\
\ipa{k} \change\ \ipa{g} / \#\ipa{k}V_V (? dissimilation?)\\
\ipa{f} \change\ \ipa{h} / V_V\#\\
\ipa{u} \change\ \ipa{w} / _V\#\\
\ipa{e} \change\ \ipa{E} / _\#

\paragraph{Zangian}

\subparagraph{Proto-Zangian to Kiamu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{t} \{\ipa{d,j}\}\\
\ipa{tj} \change\ \ipa{tS}\\
\ipa{z} \change\ \ipa{T} / _\ipa{i}\\
\ipa{d\super j} \change\ \O\ / \#_\\
\ipa{b} \change\ \ipa{w} / V_V\\
\ipa{r} \change\ \O\ / V_V\\
\ipa{wu} \change\ \O\ / V_\#\\
V \change\ \O\ / V_\#\\
\ipa{\textltailn} \change\ \ipa{n} / _\ipa{w}\\
\ipa{g} \change\ \O\ / \#_

\subparagraph{Proto-Zangian to Kimvita}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

V\ipa{r} \change\ V\ipa{:} / _V\\
\ipa{t\super j d\super j} \change\ \{\ipa{t,tS}\} \{\ipa{d,dZ}\}\\
\{\ipa{r,j}\} \change\ \O\ / V_V\\
\ipa{b} \change\ \ipa{w} / V_V\\
\ipa{wu} \change\ \ipa{O} / V_\#\\
\ipa{\textltailn} \change\ \ipa{n} / _\ipa{w}

\subparagraph{Proto-Zangian to Kitikuu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{\textltailn} \change\ \ipa{n}\\
\ipa{w b} \change\ \ipa{v w} / V_V\\
\ipa{t d} \change\ \ipa{tS dZ} / \ipa{m}_\\
N \change\ \O\ / \#V_S\\
\ipa{tj} \change\ \ipa{tS}\\
\ipa{t\super j d\super j} \change\ \ipa{t}? \ipa{j}

\subparagraph{Proto-Zangian to Kiwibu}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{l} \change\ \ipa{r}\\
\ipa{w} \change\ \{\ipa{w,v}\}\\
\ipa{b} \change\ \ipa{w} / V_V\\
\ipa{p} \change\ \O\ / \#\ipa{m}_\\
\ipa{tj} \change\ \ipa{tS}\\
\ipa{s} \change\ \ipa{S} / _\ipa{i}

\subparagraph{Proto-Zangian to Shiangazija}{\it Pogostick Man \&\ jmcd}, the former citing Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{w} \change\ \ipa{b} / \$_\\
\ipa{S} \change\ \ipa{s}\\
\ipa{t\super j d\super j} \change\ \ipa{s z} / \ipa{n}_\\
\ipa{t\super j d\super j} \change\ \ipa{ts dz}\\
\ipa{nd} \change\ \ipa{\:n\:d\:z}\\
\{\ipa{w,r}\} \change\ \O\ / V_V\#\\
\ipa{t} \change\ \ipa{r} / V_V\#\\
\ipa{\textltailn} \change\ \ipa{n} / _\ipa{w}\\
\ipa{tS} \change\ \ipa{S} / \#_ (assuming \textit{\ipa{S}uma} ``iron" isn't a loan)\\
*\ipa{k} lenites word-initially before \ipa{i} but the result varies; any of [\ipa{x \c{c} S}] seem typical\\
There seems to be sporadic voicing of the initial consonant of either the prefix or the root; might be variation or listener error

\subparagraph{Proto-Zangian to Swahili}{\it Pogostick Man}, from Johnston, Sir Harry Hamilton (1919), \textit{A Comparative Study of the Bantu and Semi-Bantu Languages}

\ipa{t\super j d\super j} \change\ \ipa{tS dZ}\\
\ipa{wu} \change\ \ipa{O} / V_\#\\
Looks like certain prefixes may get an epenthetic vowel sometimes (typically \#\ipa{m}_), but there's no obvious conditioning\\
There seems to be a few cases of initial voicing for either words or roots
...
\tab (From Rensch, Calvin R. (1977), ``ClassiÞcation of the Otomanguean Languages and the Position of Tlapanec". {\it Summer Institute of Linguistics Publications in Linguistics} 55:53 -- 108) %TO DO: MORE CORRESPONDENCES
...
\subsubsection{Proto-Chatino to Papabuco Chatino}{\it Pogostick Man}, from Upson, B.W., and Robert E. Longacre (1965), ``Proto-Chatino PhonologyÓ. International Journal of American Linguistics 31(4):312 -- 322
...
\subsubsection{Proto-Chatino to Tataltepec Chatino}{\it Pogostick Man}, from Upson, B.W., and Robert E. Longacre (1965), ``Proto-Chatino PhonologyÓ. International Journal of American Linguistics 31(4):312 -- 322
...
\subsubsection{Proto-Chatino to Yaitepec Chatino}{\it Pogostick Man}, from Upson, B.W., and Robert E. Longacre (1965), ``Proto-Chatino PhonologyÓ. International Journal of American Linguistics 31(4):312 -- 322
...
\subsubsection{Proto-Chatino to Zenzontepec Chatino}{\it Pogostick Man}, from Upson, B.W., and Robert E. Longacre (1965), ``Proto-Chatino PhonologyÓ. International Journal of American Linguistics 31(4):312 -- 322
...
\subsection{Proto-Oto-Manguean to Tlapanec}{\it Pogostick Man}, from Rensch, Calvin R. (1977), ``ClassiÞcation of the Otomanguean Languages and the Position of Tlapanec". {\it Summer Institute of Linguistics Publications in Linguistics} 55:53 -- 108
...
\tab (From Shepherd, Alice (2005), ``Proto-Wintun". {\it UC Publications in Linguistics}. \url{http://escholarship.org/uc/item/8dq1f3jj})

\subsubsection{Proto-Wintuan to Nomlaki}{\it Pogostick Man}, from Shepherd, Alice (2005), ``Proto-Wintun". {\it UC Publications in Linguistics}. \url{http://escholarship.org/uc/item/8dq1f3jj}
...
\subsubsection{Proto-Wintuan to Patwin}{\it Pogostick Man}, from Shepherd, Alice (2005), ``Proto-Wintun". {\it UC Publications in Linguistics}. \url{http://escholarship.org/uc/item/8dq1f3jj}
...
\subsubsection{Proto-Wintuan to South Patwin}{\it Pogostick Man}, from Shepherd, Alice (2005), ``Proto-Wintun". {\it UC Publications in Linguistics}. \url{http://escholarship.org/uc/item/8dq1f3jj}
...
\subsubsection{Proto-Wintuan to Wintu}{\it Pogostick Man}, from Shepherd, Alice (2005), ``Proto-Wintun". {\it UC Publications in Linguistics}. \url{http://escholarship.org/uc/item/8dq1f3jj}
...
\tab For this following section, the sound transcribed here as $\langle$\ipa{r}$\rangle$ may in actuality represent something akin to /\textipa{\*r}/. Additionally, [on liquids in Siouan languages].
...
\tab (From Hale, Kenneth (1967), ``Toward a Reconstruction of Kiowa-Tanoan Phonology". \textit{International Journal of American Linguistics}, 33.2:112 -- 120; and Wikipedia contributors (2012), ``Tanoan languages". \textit{Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Tanoan_languages&oldid=496916321})

\subsection{Proto-Tanoan to Jimez}{\it Pogostick Man}, from Wikipedia contributors (2012), ``Tanoan languages". \textit{Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Tanoan_languages&oldid=496916321}, citing Hale, Kenneth (1967), ``Toward a Reconstruction of Kiowa-Tanoan Phonology". \textit{International Journal of American Linguistics}, 33.2:112 -- 120
...
\subsection{Proto-Tanoan to Kiowa}{\it Pogostick Man}, from Wikipedia contributors (2012), ``Tanoan languages". \textit{Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Tanoan_languages&oldid=496916321}, citing Hale, Kenneth (1967), ``Toward a Reconstruction of Kiowa-Tanoan Phonology". \textit{International Journal of American Linguistics}, 33.2:112 -- 120
...
\subsection{Proto-Tanoan to Taos}{\it Pogostick Man}, from Wikipedia contributors (2012), ``Tanoan languages". \textit{Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Tanoan_languages&oldid=496916321}, citing Hale, Kenneth (1967), ``Toward a Reconstruction of Kiowa-Tanoan Phonology". \textit{International Journal of American Linguistics}, 33.2:112 -- 120
...
\subsection{Proto-Tanoan to Tewa}{\it Pogostick Man}, from Wikipedia contributors (2012), ``Tanoan languages". \textit{Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Tanoan_languages&oldid=496916321}, citing Hale, Kenneth (1967), ``Toward a Reconstruction of Kiowa-Tanoan Phonology". \textit{International Journal of American Linguistics}, 33.2:112 -- 120
...
\item \^{e} \^{o} may haveÊbeen semi-rounded forms of /\textipa{I U}/.
...
\tab (From Wikipedia contributors (2011), \textquotedblleft Proto-Uralic language". \textit{Wikipedia, The Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Proto-Uralic_language\&oldid=442512196}; the TCL thread and KQ pages proper; and Tropylium.)

\subsection{Proto-Uralic to Pre-Finnic}{\it Tropylium}, from Hakulinen, Lauri (1979), ``Suomen kielen rakenne ja kehitys". {\it Otava}; H\"{a}kkinen, Kaisa (2004), ``Nykysuomen etymologinen sanakirja". {\it WSOY}; Kallio, Petri (2007), ``Kantasuomen konsonanttihistoriaa". {\it M\'{e}moires de la Soci\'{e}t\'{e} Finno-Ougrienne} 253. \url{http://www.sgr.fi/sust/sust253/sust253_kallio.pdf}; and from Janhunen, Juha (2007), ``The primary laryngeal in Uralic and beyond". {\it M\'{e}moires de la Soci\'{e}t\'{e} Finno-Ougrienne} 253. \url{http://www.sgr.fi/sust/sust253/sust253_janhunen.pdf}
...
\tab (From Wikipedia contributors (2011), ÒProto-Uto-Aztecan languageÓ. {\it Wikipedia, the Free Encyclopedia}. \url{ http://en.wikipedia.org/w/index.php?title=Proto-Uto-Aztecan_language&oldid=406159488}; and from Radius SolisÕ changes listed on KneeQuickie and in the TCL thread proper)
...
\subsection{Proto-Uto-Aztecan to Hopi}{\it Radius Solis}, from from Voegelin, Charles F., Florence M. Voegelin, \& Kenneth L. Hale (1962), ``Typological and Comparative Grammar of Uto-Aztecan: I (Phonology)Ó. {\it International Journal of American Linguistics} 28: Memoir 17
...
\subsection{Proto-Uto-Aztecan to Luise\~{n}o}{\it Radius Solis}, from from Voegelin, Charles F., Florence M. Voegelin, \& Kenneth L. Hale (1962), ``Typological and Comparative Grammar of Uto-Aztecan: I (Phonology)Ó. {\it International Journal of American Linguistics} 28: Memoir 17
...
\subsection{Proto-Uto-Aztecan to Nahuatl}{\it Radius Solis}, from from Voegelin, Charles F., Florence M. Voegelin, \& Kenneth L. Hale (1962), ``Typological and Comparative Grammar of Uto-Aztecan: I (Phonology)Ó. {\it International Journal of American Linguistics} 28: Memoir 17
...
\subsection{Proto-Uto-Aztecan to Tohono O'odham}{\it Radius Solis}, from from Voegelin, Charles F., Florence M. Voegelin, \& Kenneth L. Hale (1962), ``Typological and Comparative Grammar of Uto-Aztecan: I (Phonology)Ó. {\it International Journal of American Linguistics} 28: Memoir 17
...
\tab (From Egurtzegi, Ander (2013), ``Phonetics and Phonology", in {\it Basque and Proto-Basque}. \url{https://www.academia.edu/3570162/2013a_-_Basque_and_Proto-Basque_Phonetics_and_Phonology})

\subsection{Proto-Vasconic to Aquitanian}{\it Pogostick Man}, from Egurtzegi, Ander (2013), ``Phonetics and Phonology", in {\it Basque and Proto-Basque}. \url{https://www.academia.edu/3570162/2013a_-_Basque_and_Proto-Basque_Phonetics_and_Phonology}; Owstrowski, Manfred, ``History of the Basque Language". \url{http://hisp462.tamu.edu/Classes/603/Lects/BasqueHist.pdf}; Wikipedia contributors (2014), ``Aquitanian langauge". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Aquitanian_language&oldid=609638407}; Wikipedia contributors (2014), "Basque language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Basque_language&oldid=610796497}; and Wikipedia contributors (2014), ``Vasconic languages". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Vasconic_languages&oldid=607530415}
...
\subsection{Proto-Basque to Basque}{\it Pogostick Man}, from Egurtzegi, Ander (2013), "Phonetics and Phonology", in {\it Basque and Proto-Basque}. \url{https://www.academia.edu/3570162/2013a_-_Basque_and_Proto-Basque_Phonetics_and_Phonology}; Owstrowski, Manfred, ``History of the Basque Language" \url{http://hisp462.tamu.edu/Classes/603/Lects/BasqueHist.pdf}; Wikipedia contributors (2014), ``Proto-Basque language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Proto-Basque_language&oldid=605488703}; Wikipedia contributors (2014), ``Aquitanian langauge". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Aquitanian_language&oldid=609638407}; Wikipedia contributors (2014), ``Basque language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Basque_language&oldid=610796497}; Wikipedia contributors (2014), ``Iberian language". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Iberian_language&oldid=601317949}; Wikipedia contributors (2014), ``Basque dialects". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Basque_dialects&oldid=595514648}; Wikipedia contributors (2014), ``Biscayan dialect". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Biscayan_dialect&oldid=613190357}; Wikipedia contributors (2014), ``Gipuzkoan dialect". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Gipuzkoan_dialect&oldid=606871281}; Wikipedia contributors (2014), ``Vasconic languages". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Vasconic_languages&oldid=607530415}; and Wikipedia contributors (2014), ``Navarro-Lapurdian dialect". {\it Wikipedia, the Free Encyclopedia}. \url{http://en.wikipedia.org/w/index.php?title=Navarro-Lapurdian_dialect&oldid=601150726}; and Campbell, Lyle, ``Language Isolates and Their History, or, What's Weird, Anyway?". \url{http://www2.hawaii.edu/~lylecamp/CAMPBELL%20BLS%20isolates.pdf}
...
\subsection{California Vowel Shift (English)}{\it Pogostick Man}, from Wikipedia contributors (2013), ``California English". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=California_English&oldid=584388388}; and Eckert, Penelope, ``Vowel Shifts in Northern California and the Detroit Suburbs". \url{http://www.stanford.edu/~eckert/vowels.html}
...
\subsection{Belgian and Netherlandish Dutch Monophthongization}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Dutch Phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dutch_phonology&oldid=602553868}

\ipa{Ei \oe y Ou} \change\ \ipa{E: \oe: O:}

\subsection{Polder Dutch Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2014), ``Dutch Phonology". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Dutch_phonology&oldid=602553868}
...
\subsection{Old Norse to Early Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\ipa{i:} \change\ \ipa{y:}\\
\ipa{y} \change\ \ipa{i}\\
\ipa{O E} \change\ \ipa{o e}\\
\ipa{a: e:} \change\ \ipa{O: E:}\\
\ipa{au \o y ei} \change\ \ipa{O0 \oe y \ae i}

\subsubsection{Early Faroese to Old North Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\ipa{O a} \change\ \ipa{\o\ E}\\
\ipa{o:} \change\ \ipa{3u}\\
\ipa{u: y:} \change\ \ipa{0u UI}\\
\ipa{O0 \oe y \ae i} \change\ \ipa{EI OI aI}\\

\paragraph{Old North Faroese to Late Old North Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\textit{NB: Slashes indicate long/short reflexes, respectively.}

\ipa{u o O \o E e i} \change\ \ipa{u:/U o:/O O:\textsubarch{a}/O\textsubarch{a} \o:/\oe\ E:\textsubarch{a}/E\textsubarch{a} e:/E i:/I}\\
\ipa{0u 3u UI} \change\ \ipa{0u/0Y 3u/3 UI/U\textsubarch{I}}\\
\ipa{OI aI EI} \change\ \ipa{OI/O\textsubarch{I} aI/a\textsubarch{I} EI/E\textsubarch{I}}

\subparagraph{Late Old North Faroese to New North Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\ipa{0Y} \change\ \ipa{Y}\\
\ipa{UI U\textsubarch{I}} \change\ \ipa{ui U\textsubarch{I}}\\
\ipa{O:\textsubarch{a} O\textsubarch{a} E:\textsubarch{a} E\textsubarch{a}} \change\ \ipa{Oa O Ea a}\\
\{\ipa{OI,aI}\} \{\ipa{O\textsubarch{I},a\textsubarch{I}}\} \ipa{EI E\textsubarch{I}} \change\ \ipa{Oi O Ei E}

\subsubsection{Early Faroese to Old South Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\textit{NB: Slashes indicate long/short reflexes, respectively.}

\ipa{u o O \o\ a e i} \change\ \ipa{u: o \o: E: \o\ e: i:}\\
\ipa{u: o: O: y: E:} \change\ \ipa{0u Ou O:\textsubarch{a}/O\textsubarch{a} U: e:}\\
\ipa{O0 \oe y \ae i} \change\ \ipa{EI OI aI}

\paragraph{Old South Faroese to Late Old South Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\textit{NB: Slashes indicate long/short reflexes, respectively.}

\ipa{u: o \o(:) E: e: i:} \change\ \ipa{u:/U o:/O \o:/\oe\ E:\textsubarch{a}/E\textsubarch{a} e/E i:/I}\\
\ipa{Ou 0u UI} \change\ \ipa{Ou/O 0u/0\textsubarch{Y} UI/U\textsubarch{I}}\\
\ipa{OI aI EI} \change\ \ipa{OI/O\textsubarch{I} aI/a\textsubarch{I} EI/E\textsubarch{I}}

\subparagraph{Late Old South Faroese to New South Faroese Vowel Shift}{\it Pogostick Man}, from Wikipedia contributors (2015), ``Faroese language". \textit{Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Faroese_language&oldid=664109713}

\{\ipa{\oe,0\textsubarch{Y}}\} \change\ \ipa{Y}\\
\ipa{O:a Oa E:\textsubarch{a} E\textsubarch{a}} \change\ \ipa{Oa O Ea a}\\
\ipa{UI U\textsubarch{I}} \change\ \ipa{ui U\textsubarch{I}}\\
\ipa{Oi Ei} \change\ \ipa{O E}\\
\ipa{aI a\textsubarch{I}} \change\ \ipa{ai a\textsubarch{I}}

\subsection{Northern Cities Vowel Shift (English)}{\it Pogostick Man}, from Wikipedia contributors (2013), ``Northern Cities Vowel Shift". {\it Wikipedia, the Free Encyclopedia}. \url{https://en.wikipedia.org/w/index.php?title=Northern_Cities_Vowel_Shift&oldid=581062574}
